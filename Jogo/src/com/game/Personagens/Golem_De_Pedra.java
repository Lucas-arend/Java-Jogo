...
public class Golem_De_Pedra extends Personagem{
	...
	public Golem_De_Pedra(long id) {
		...
		habilidades[0] = new Habilidade("Golpe resiliente", " causa um dano normal e aumenta sua defesa em 10% por 1 turno.", Arrays.asList(CaracteristicasHabilidade.DANO, CaracteristicasHabilidade.DEFESA), 0, 0);
	    habilidades[1] = new Habilidade("Absorção de defesa", "Reduz a defesa de todo o time adversário e aumenta a propria defesa por 2 turnos.", Arrays.asList(CaracteristicasHabilidade.DEFESA, CaracteristicasHabilidade.MENOS_DEFESA), 1, 5); // começa em CD
	    ...
	    habilidades[3] = new Habilidade("Deslisamento", "Causa dano em todos os adversários.", Arrays.asList(CaracteristicasHabilidade.DANO_LETAL), 4, 2); // começa em CD
